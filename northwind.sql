...
CREATE OR REPLACE VIEW mydatabase.public.vw_total_revenue_1977 as 
with
	order_details as (
		select *
...
CREATE OR REPLACE VIEW mydatabase.public.vw_ytd_calculation as
with
	order_details as (
		select *
		from mydatabase.public.order_details
...
CREATE OR REPLACE VIEW mydatabase.public.vw_total_revenue_per_customer as
with
	order_details as (
		select *
		from mydatabase.public.order_details
...
CREATE OR REPLACE VIEW mydatabase.public.vw_total_revenue_per_customer_group as
with
	order_details as (
		select *
		from mydatabase.public.order_details
...
CREATE OR REPLACE VIEW mydatabase.public.vw_total_revenue_per_customer_group_filtered as
with
	order_details as (
		select *
		from mydatabase.public.order_details
...
CREATE OR REPLACE VIEW mydatabase.public.vw_top_10_products as
with
	order_details as (
		select *
		from mydatabase.public.order_details
...
CREATE OR REPLACE VIEW mydatabase.public.vw_uk_customers_spend_1000 as
with
	order_details as (
		select *
		from mydatabase.public.order_details
